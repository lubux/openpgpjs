...
module.exports = () => describe('API functional testing', function() {
  ...
  describe('Sign and verify', function () {
    ...
    it('Ed448', async function () {
      ...
      const toSign = await crypto.hash.digest(openpgp.enums.hash.sha256, data);
      const signedData = await crypto.signature.sign(
        openpgp.enums.publicKey.ed448, openpgp.enums.hash.sha256, { A }, { seed }, data, toSign
      );
      const success = await crypto.signature.verify(
        openpgp.enums.publicKey.ed448, openpgp.enums.hash.sha256, signedData, { A }, data, toSign
      );
